import { StartFunc as StartFuncFromIsMobile } from "./isMobile.js";
import { StartFunc as StartFuncFromIsNotMobile } from "./isNotMobile.js";
...
toggleRecordBtn.addEventListener("click", () => {
    const toggleRecordLabel = document.getElementById("toggleRecordLabel");
    // addNote(toggleRecordLabel.textContent === "Pause Listening");
    if (recognizing) {
...
if (isMobile()) {
    console.log("aaaaaaaaaaa : ", keshav);

    StartFuncFromIsMobile();
} else {
    console.log("bbbbbbbbbbb : ", keshav);
    StartFuncFromIsNotMobile();
};